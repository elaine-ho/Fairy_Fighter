 ...
 */
public class BadEnd extends State
{
    private int line;
     ...
     */
    public BadEnd(Game game)
    {
        super(game);
        text = new ArrayList<String>();
        speaker = new int[]{2,1,2,1,2,2};
        speak = false;
        try{
            Scanner fileIn = new Scanner(new FileReader("res/bad end.txt"));
            int p;
    ...
    public void render(Graphics g){
        if (speak){
            g.drawImage(Assets.badEnd,0,0,null);
        }
        else{
